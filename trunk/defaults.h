#ifndef _defaults_h_
  #define _defaults_h_
  // Target Windows 5.2 and up (Windows XP). Required to be able to use VEH.
  ...
  // Architectures specific settings:
    ...
    #define FMT_VAL "0x%016X"             // Value format string
    ...
    #define FMT_VAL "0x%08X"              // Value format string
